...
//
// Two data structures are introduced to ensure internal consistency. Those will be explained below.
...
// 2. The Reconciler will automatically delete all aliases to the cluster if the cluster was requested to be removed.
...
// Description describes an alias, its cluster, port and attached upstreams. It also shows if the current port is used for active probing.
